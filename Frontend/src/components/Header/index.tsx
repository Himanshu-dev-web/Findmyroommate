        ...
        >
          ...
          >
            <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              <span className="self-center text-xl font-mono   whitespace-nowrap dark:text-white ">Findmyroommate</span>
            </Link>
          </Stack>
          <NavItems />
          <Stack
          ...
          >
            <Link href={'/listing/add'} className="mr-4">
              <button className="hidden sm:flex text-primaryBlue border font-mono text-[14px] border-primaryBlue px-6 py-1 rounded-[56px] relative">Listing <span className="absolute bg-white text-[24px] top-[-20px] right-1 font-geist-sans w-[20px]">+</span></button>
            </Link>
